...
一套完整的等保 2.0 知识库，涵盖法律法规（含 2025-2026 最新：网安法修订、网络数据安全管理条例、网络数据安全风险评估办法、公安网络空间安全监督检查办法）、等保标准（含 2025-2026 新技术扩展行标与数据安全专项标准）、安全基线（Linux/Windows/数据库/云安全）、漏洞速查、安全事件案例和等保整改案例。可作为等保定级助手和差距分析专家的后台知识支撑，也可独立用于安全运维、基线加固、应急响应等场景。
...
├── SKILL.md                          # 本文档 — 快速导航入口
├── references/
│   └── 全部内容.md                   # 完整知识库（35+ 主题，单文件合并版）
│
├── laws/                              # 法律法规
│   ├── 网络安全法                     # 2017.6.1 施行，等保制度法律依据；2025修订版2026.1.1施行
│   ├── 数据安全法                     # 2021.9.1 施行，数据分类分级+重要数据保护
│   ├── 个保法                         # 2021.11.1 施行，个人信息保护全链条
│   ├── 网络数据安全管理条例           # 2025.1.1 施行，9章64条
│   ├── 网络数据安全风险评估办法       # 2026.8.20 施行，三部门联合发布
│   ├── 公安网络空间安全监督检查办法   # 公安部令第176号，2026.10.1 施行
│   └── 公网安2020-1960号指导意见      # 等保+关保双制度落实纲领
│
├── 等保标准/                           # 等保2.0 核心标准
│   ├── GB_T_22239                    # 基本要求（10个安全类）
│   ├── GB_T_28448                    # 测评要求 — 访谈/检查/测试方法
│   ├── GB_T_25070                    # 安全设计技术要求 — 三重防护体系
│   ├── GA_T_1390_6~9-2025            # 新技术扩展：边缘计算/大数据/IPv6/区块链（2026.2.1实施）
│   ├── GA_T_2347_2348-2025           # 云计算测评指引 + 5G接入测评要求（2026.2.1实施）
│   └── GA_T_2380_2381_2394_2395-2026 # 数据安全专项：基本要求/机构能力/测评要求/过程指南
│
