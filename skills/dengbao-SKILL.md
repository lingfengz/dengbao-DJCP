...
| Skill | 文件名 | 用途 |
|-------|--------|------|
| **等保测评知识库** | `等保测评知识库/` | 35+ 主题完整知识库（单文件合并版；法规/基线/案例/漏洞） |
...
| Skill | 文件名 | 用途 |
|-------|--------|------|
| **关键信息基础设施保护专家** | `关键信息基础设施保护专家.md` | 关基认定判断、责任体系、GB/T 39204 六大活动、检查应对与年度合规统筹 |
...
| GB/T 36959-2026 | 测评机构能力要求 | 替代 36959-2018，2026-12-01 实施（实施前仍按 2018 版） |
| GA/T 1390.6~9-2025 | 新技术扩展要求 | 边缘计算/大数据/IPv6/区块链（2026-02-01 实施） |
| GA/T 2347/2348-2025 | 新技术测评标准 | 云计算测评指引 + 5G 接入测评要求（2026-02-01 实施） |
| GA/T 2380/2381-2026 | 数据安全专项 | 数据安全基本要求 + 测评机构能力要求（2026-06-01 实施） |
| GA/T 2394/2395-2026 | 数据安全测评 | 数据安全测评要求 + 过程指南（2026-07-01 实施） |

## 2026 政策速览（2026-08 更新）

| 文件 | 文号/标准号 | 时间节点 | 要点 |
|------|------------|---------|------|
| 网络安全法（修订） | 2025-10-28 通过 | 2026-01-01 施行 | 处罚大幅提高、AI 条款、个保衔接 |
| 网络数据安全管理条例 | 国务院令第790号 | 2025-01-01 施行 | 9章64条，数据全生命周期 |
| 网络数据安全风险评估办法 | 网信办等三部门 | 2026-08-20 施行 | 风险评估机构认证、重大风险通知 |
| 公安机关网络空间安全监督检查办法 | 公安部令第176号 | 2026-10-01 施行 | 三级以上每年现场检查、提示函/约谈 |
| 等保新技术行标（6项） | GA/T 1390.6~9-2025、2347/2348-2025 | 2026-02-01 实施 | 边缘计算/大数据/IPv6/区块链/云/5G |
| 等保数据安全专项标准（4项） | GA/T 2380/2381/2394/2395-2026 | 2026-06/07-01 实施 | 数据安全基本要求+测评要求+机构能力 |
| 高风险判定实施指引（2025版） | 公网安〔2025〕2391号 | 2025 印发 | 5大板块 81 项判例 |
