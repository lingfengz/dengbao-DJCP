...
| [等保测评项目经理](skill-maps/map-等保测评项目经理.md) | 测评项目负责人、测评机构管理者 | 项目全生命周期（GB/T 28449 四阶段）、进度成本、三级审核质量体系、风险管理、干系人沟通、多项目并行 |
| [等保渗透测试工程师](skill-maps/map-等保渗透测试工程师.md) | 渗透测试人员、红队人员 | 授权红线、PTES 方法论、漏洞发现与利用、等保场景化测试用例、报告与整改验证 |
| [密评工程师](skill-maps/map-密评工程师.md) | 商用密码应用安全评估人员 | 密码法规标准、国密算法与协议、GB/T 39786 四层面、密码产品合规、密评流程与量化评估 |
| [关保工程师](skill-maps/map-关保工程师.md) | 关基运营者安全负责人 | 关保条例、GB/T 39204 六大保护活动、认定与责任体系、供应链安全、合规日历 |

后续计划中的领域（欢迎贡献）：

- 数据安全官（数据分类分级 / 数据安全治理）技能图谱
- 信创安全（国产化环境安全建设）技能图谱
...
**本次更新补齐了项目自开源以来标记“正在建设中”的 4 份技能图谱**，技能图谱数量 3 → 7，角色覆盖从测评执行延伸到项目管理、渗透测试、密评与关保。

### 🗺 新增技能图谱（4 份）

| 图谱 | 适用角色 | 核心内容 |
|------|---------|---------|
| 等保测评项目经理 | 测评项目负责人 | GB/T 28449 四阶段项目全生命周期 / 进度成本 / 三级审核质量体系 / 风险登记 / 干系人沟通 |
...
**本次更新将等保体系从"以系统为中心"推向"系统与数据并重"** —— 数据安全正式成为独立测评维度，这是 2026 年最重要的体系变化。

### 🏛 新增法规（4 份）

| 法规 | 文号/时间 | 要点 |
|------|-----------|------|
| 网络安全法（2025 修订版） | 2025-10-28 通过，2026-01-01 施行 | 四大修订方向（党的领导 / AI 条款 / 个保衔接 / 处罚）；处罚最高 1000 万 |
| 网络数据安全管理条例 | 国务院令第 790 号，2025-01-01 施行 | 9 章 64 条；数据分类分级 / 重要数据 / 出境三路径 |
| 网络数据安全风险评估办法 | 网信办等三部门，2026-08-20 施行 | 风险评估定义、评估机构认证、重大风险通知 |
| 公安机关网络空间安全监督检查办法 | 公安部令第 176 号，2026-10-01 施行 | 23 条六方面；三级以上每年一次现场检查；取代 2018 年 151 号令 |

### 📐 新增标准（10 项）

| 类别 | 标准号 |
|------|--------|
| 🟠 新技术行标（2026-02-01 实施） | GA/T 1390.6~9-2025（边缘计算/大数据/IPv6/区块链）、GA/T 2347/2348-2025（云计算测评 / 5G 接入测评） |
| 🟠 数据安全专项（2026-06/07 实施） | GA/T 2380/2381-2026（基本要求 / 机构能力）、GA/T 2394/2395-2026（测评要求 / 过程指南） |

### 🔁 Skill 联动修订（8 个文件）

- 高风险判定实施指引 → 标注 2025 版官方现行（公网安〔2025〕2391 号，81 项判例）
- 重大风险问题指导 / 差距分析专家 / 报告生成器 / 项目管理专家 / 政策解读专家 → 同步新规新标
- `dengbao-SKILL.md` 入口 → 核心标准表新增 6 行新标准 + "2026 政策速览"表
- 人格与记忆 → 版本记录新增 v2.1

### 📄 文档修复

- `README.md` skill 数量统一为 22；版本升级 v2.1
